...
(function ($) {
  ...
  const pro_images = importAll(require.context('../../images/fulls/full/', true, /\.webp$/));
  ...
  function canvasfpro(gic, gifn) {
    for (let i = 0; i < gic; i++) {
      ...
      pimg.src = "global/assets/images/" + gifn + (i + 1) + ".webp";
