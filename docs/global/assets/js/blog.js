...
(function ($) {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 2:
            _context.prev = 2;
            _context.next = 5;
            return fetch("https://shoenix-studios.web.app/blog-post.json");
          case 5:
  ...
  var blog_post = $(".timeline");
  fetchDB().then(function (blogjson) {
    if (bodyLangCode == 'en') {
    ...
    for (i = 0; i < blog_languagetyp.length; i++) {
      var blog_Article = document.createElement("li");
      var blog_icon = document.createElement("label");
      var blog_Article_Main = document.createElement("div");
      var blog_Main_date = document.createElement("p");
      var blog_Main_title = document.createElement("h3");
      var blog_Main_Author = document.createElement("h4");
      var blog_Main_para1 = document.createElement("p");
      var blog_Main_para2 = document.createElement("p");
      ...
      blog_Main_para1.id = "para1";
      blog_Main_para2.id = "para2";
    ...
    var blog_Article = document.createElement("h1");
    if (bodyLangCode == 'en') {
