...
(function ($) {
	...
	$('.stpage').on('click', function (e) {
		...
		if (fetchnumber == 1) {
			...
			document.querySelector('.artcontent .poster').style.background = "url('assets/css/images/overlay-poster.webp') center no-repeat, url('images/fulls/full/st7.webp') center no-repeat";
			...
			document.querySelector('#center-image').style.cssText = `
				...
				background-position: top center;
				background-repeat: no-repeat;`;
			document.querySelector('.artcontent .poster').style.background = "url('assets/css/images/overlay-poster.webp') center no-repeat, url('images/fulls/full/ic3.webp') center no-repeat";
